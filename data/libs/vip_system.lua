...
function Player.onRemoveVip(self)
	...
	local outfitsToDelete = {1023, 1331, 750} -- outfits ids
	local mountsToDelete = {168} -- mounts id
...
function Player.addAddonMount(self)
	...
	local outfitsToUpgrade = {1023, 1331, 750} -- add outfits ids
	local mountsToUpgrade = {168} -- add mounts ids
